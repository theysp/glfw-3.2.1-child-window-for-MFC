...
static HWND win32parentHWND = NULL;
                              ...
                              _GLFWwndconfig* wndconfig)
{
    ...
    else
    {
        ...
        if (_glfw.hints.child) {
            ...
            getFullWindowSize(style, exStyle,
                ...
                &tmpW, &tmpH);
            wndconfig->width -= (tmpW - wndconfig->width);
            wndconfig->height -= (tmpW - wndconfig->height);
        }
        else
        {
            getFullWindowSize(style, exStyle,
    ...
    window->win32.handle = CreateWindowExW(exStyle,
                                           ...
                                           xpos, ypos,
                                           fullWidth, fullHeight,
                                           _glfw.hints.child? win32parentHWND :NULL, //YSP 2017-10-22 No parent window
                                           NULL, // No window menu
...
{
    if (_glfw.hints.child)
        return 1;//YSP 2017-10-22 to deal with the child window issue
...
//////////////////////////////////////////////////////////////////////////
//////          GLFW native API setting the parent wnd              //////
//////////////////////////////////////////////////////////////////////////
...
GLFWAPI HWND glfwSetWin32WindowParent(HWND parentHandle)
{
	...
	return win32parentHWND = parentHandle;
}
